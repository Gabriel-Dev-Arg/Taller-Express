...
import { create,crearNuevosEmpleados } from "../controllers/empleados/create.js";
...
// Ejemplo de ruta: localhost:8080/api/empleados/crearMultiples
router.post("/crearMultiples",crearNuevosEmpleados);
